...
- The kernel files in the [kernel_h6](https://github.com/ophub/kernel/releases/tag/kernel_h6) section of the Releases are a `dedicated version` for the `Allwinner H6 (TQC-A01)` device and are not interchangeable with other series.
