...
- Releases 中的 [kernel_h6](https://github.com/ophub/kernel/releases/tag/kernel_h6) 为 `全志 H6（TQC-A01）` 设备的`专用版本`，与其他系列不通用。现在 `TQC-A01` 已经切换为使用主线 [kernel_stable/6.18.y](https://github.com/ophub/kernel/releases/tag/kernel_stable) 内核。
